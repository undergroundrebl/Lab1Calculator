...
'''def add(arg1,arg2):
	...
	if( (type_arg1 == type_arg2) and (type_arg1 == "<type 'int'>") ):
	 ...
	 print "ERROR", type(in1), "is not equal to", type(in2), "or the type is not supported"
	 '''
...
while(again):
	...
	while(modeSLT):
		...
		ad0sb = input("addition (+) : subtraction (-) ")
	...
	again = input("Go again? Type 1 for yes, 0 for no: ")
'''	